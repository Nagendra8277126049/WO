({
                ...
                if (state === "SUCCESS") {
                    ...
                    //end   
                        ...
                        component.set("v.assetAlerts", null);
                         ...
                         //this.showToast(component,'Error', $A.get("$Label.c.CustomerAlertsDashboardErrorMessage"), "Error");
                    }
                } else {
                    this.showToast(component, 'Error', $A.get("$Label.c.CustomerAlertsDashboardErrorMessage"), "Error");
                }
    ...
    openSubTab: function(component) {
        try {
            ...
            evt.setParams({
                componentDef : "c:CustomerAlertDetails",
                componentAttributes: {
            ...
            */
            ...
            var pageReference = {
                ...
                "attributes": {
                    "componentName": "c__CustomerAlertDetails"
                },
                "state": {
                    "recId": component.get("v.recordId")
                }
